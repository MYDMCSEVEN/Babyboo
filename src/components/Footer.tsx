        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/boutique" className="text-baby-text/70 hover:text-baby-brown">Boutique</Link></li>
              <li><Link href="/notre-histoire" className="text-baby-text/70 hover:text-baby-brown">Notre Histoire</Link></li>
              <li><Link href="/contact" className="text-baby-text/70 hover:text-baby-brown">Contact</Link></li>
              <li><Link href="/mentions-legales" className="text-baby-text/70 hover:text-baby-brown">Mentions légales</Link></li>
            </ul>
          </div>
          <div>
            ...
            <a
              ...
              className="inline-flex items-center space-x-2 text-baby-text/70 hover:text-baby-brown text-sm"
            >
