      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 md:h-20">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/compte" className="text-baby-text hover:text-baby-brown transition">
        ...
        {menuOpen && (
          <nav className="md:hidden pb-4 space-y-1 border-t border-baby-brown/10 pt-3">
            ...
            <Link href="/compte" className="block py-3 px-2 text-baby-text hover:text-baby-brown hover:bg-baby-beige rounded-lg transition" onClick={() => setMenuOpen(false)}>
              Mon compte
            </Link>
          </nav>
        )}
